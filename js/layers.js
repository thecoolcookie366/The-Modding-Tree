    ...
    upgrades: {
        ...
        12: {
            ...
            cost: new Decimal(500),
                effect() {
        return player.points.add(1).pow(0.022)
    },
    effectDisplay() { return format(upgradeEffect(this.layer, this.id))+"x" }, // Add formatting to the effect
        },
    },
...
addLayer("y", {
    ...
    color: "#eeff00ff",
    requires: new Decimal(3.5e9), // Can be a function that takes requirement increases into account
...
addLayer("b", {
    ...
    color: "#0077ffff",
    requires: new Decimal(4.5e14), // Can be a function that takes requirement increases into account
...
addLayer("pr", {
    ...
    color: "#4a7b91ff",
    requires: new Decimal(8e13), // Can be a function that takes requirement increases into account
...
addLayer("ap", {
    ...
    color: "#828f35ff",
    requires: new Decimal(5.5e15), // Can be a function that takes requirement increases into account
