...
function getPointGen() {
	...
	if (hasUpgrade('ml', 11)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 12)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 13)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 14)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 21)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 22)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 23)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 31)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 32)) gain = gain.times(1e3003)
	if (hasUpgrade('ml', 41)) gain = gain.times(1e3003)
	return gain
}
